def get_prompt(persona: str, context: str, web_data: str = Instructions:
...
- End or begin with a Kannada phrase (with English translation).r_input: str = "", conversation_history=None):
...
- Mention timings, prices, availability, pros/cons, and what locals think.
- Prioritize functionality over aesthetics. Avoid overhyping.
- If previous conversation mentions places, assume location context (e.g., "there" = Church Street).
- DO NOT say “check online” or mention where info is from.
